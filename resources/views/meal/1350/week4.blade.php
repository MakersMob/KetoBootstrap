		...
		<div class="row">
			<div class="col-12 col-lg-8">
				...
				<ul>
					...
					<li>Lunch: <a href="/recipe/bacon-burger-bombs">Bacon Burger Bombs</a></li>
					<li>Dinner: <a href="/recipe/spicy-chicken-artichoke-dip-casserole">Spicy Artichoke Dip Casserole</a></li>
					<li>Snack or Dessert: <a href="/recipe/raspberry-avocado-smoothie">Raspberry Avocado Smoothie</a></li>
				</ul>
				<h2>Day 4</h2>
				<ul>
