@extends('layouts.app', ['title' => 'Meal Plan: 1350 - 1450 Calories Week 4'])
...
<section class="welcome food">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h1>1350 - 1450 Calories: Week 4</h1>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-12 col-lg-8">
				...
				<ul>
					...
					<li>Lunch: <a href="https://ketodash.com/recipe/bacon-burger-bombs">Bacon Burger Bombs</a></li>
					<li>Dinner: <a href="https://ketodash.com/recipe/spicy-chicken-artichoke-dip-casserole">Spicy Artichoke Dip Casserole</a></li>
					<li>Snack or Dessert: <a href="https://ketodash.com/recipe/raspberry-avocado-smoothie">Raspberry Avocado Smoothie</a></li>
				</ul>
				<h2>Day 4</h2>
				<ul>
