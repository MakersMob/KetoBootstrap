...
<head>
    ...
    <meta name="p:domain_verify" content="b32a78387e95fe639a5d96c5386dd1a2"/>
...
<body>
    <div id="app">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p style="margin-bottom: 0;"><a class="btn btn-lg btn-primary" href="/join">Sign up today! &#8594;</a></p>
                    </div>
                </div>
            </div>    
        </section>-->
        ...
        <footer>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p>&copy; Makers Mob LLC. | <a href="/keto-diet">Ketogenic Diet Guide</a> | <a href="/keto-shopping-list">Keto Shopping List</a> | <a href="/blog">Keto Blog</a> | <a href="/keto-meal-plan">Keto Diet Menu</a> | <a href="/privacy-policy">Privacy Policy</a></p>
                    </div>
                </div>
            </div>
        </footer>
    ...
    @if (ENV('APP_ENV') == 'production')
        ...
        <script type="text/javascript">
          var _dcq = _dcq || [];
          var _dcs = _dcs || {};
          _dcs.account = '9033474';

          (function() {
            var dc = document.createElement('script');
            dc.type = 'text/javascript'; dc.async = true;
            dc.src = '//tag.getdrip.com/9033474.js';
